...
import animais.aves.Papagaio;
import animais.aves.Tucano;
import animais.carnivoros.Hiena;
import animais.carnivoros.Leao;
import animais.mamiferos.Elefante;
import animais.mamiferos.Girafa;
...
public class Programa {
    public static void main(String[] args) {
        ...
        animais.add(new Tucano("Narigudo"));
        animais.add(new Hiena("Carniceira"));
        animais.add(new Girafa("Pescoçinho"));
        ...
        // Imprimir informações sobre os animais
